...
// Unblock iCongo Platform product image zoom
	...
	if((hostname.indexOf('tokyo.jp')>-1)||(hostname.indexOf('lg.jp')>-1)){			// PATCH-186, tokyo.jp, lg.jp enable maps
		...
		FileList = undefined;
		File = undefined;
			if(self==top)postError.call(opera, 'Opera has modified the JavaScript on '+hostname+' (skydrive: disable new upload code due to various Opera bugs). See browser.js for details');
