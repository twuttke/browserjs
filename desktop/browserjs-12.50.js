// 
/**
...
(function(opera){
	...
	var bjsversion=' Opera Desktop 12.50 core 2.12.378, August 27, 2012. Active patches: 202 ';
	...
	function log(str){
		...
		if(typeof CustomEvent=='function')window.dispatchEvent.call(opera, new CustomEvent('bjspatchEvent'));
...
// PATCH-622, Unblock iCongo Platform product image zoom
	...
	if((hostname.indexOf('tokyo.jp')>-1)||(hostname.indexOf('lg.jp')>-1)){
		...
		if(hostname.indexOf('mail.google.')>-1){
			...
			log('PATCH-582, GMail: override workaround for old font-size bug in Opera');
		}
		log('0, Google');
